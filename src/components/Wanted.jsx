  ...
  return(
    <div className='container'>
      ...
      <div className='info'>
        ...
        <Section title="Date of Birth Used:"
        ...
        <Section title='Possible countries:' desc={info.possible_countries} />
        )}
        ...
        {(info.height_min || info.height_max) && (  <Section title='Height : ' desc={info.height_max || info.height_min} /> )}
        ...
        {info.details && (<Section title='Details : ' desc={info.details.replaceAll("<p>", "").replaceAll("</p>", "")} brk />)}
        {info.warning_message && (<Section title='Warning : ' desc={info.warning_message} warning={true} />)}
